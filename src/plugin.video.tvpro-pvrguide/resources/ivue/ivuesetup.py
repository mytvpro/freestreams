...
tvproini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvproPVRguide/resources/ivue','addons2.ini.ini'))
...
iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvproPVRguide/resources/ivue','ivuesettings.xml'))
iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvproPVRguide/resources/ivue'))
...
def iVueInt2():
	...
	xbmc.executebuiltin('RunAddon(plugin.video.tvproPVRguide)')
	...
	b = a.replace('<tvproPVRguideUN>',username).replace('<tvproPVRguidePW>',password)
...
def tvproskin_install(name,url):
    ...
    lib=os.path.join(path, 'tvproPVRguide.zip')
    try:
       os.remove(lib)
    except:
       pass
