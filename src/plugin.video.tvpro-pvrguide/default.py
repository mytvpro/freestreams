...
espn       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
kids       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
newsca       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
newsus       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
newsuk       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
premovies       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
reality       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
docs       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
networks       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
airing       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
guide         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
extra         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
catch         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
vodtv         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
american       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
britsh       = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
international         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
music         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
music2         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
adult         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
ppv         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
mlb         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
sports2         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
nba         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
nfl         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
cache         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
nhl         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
speed         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
ncaa         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
mls         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
topenglish         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
entertainment         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
nascar         = xbmc.translatePath(os.path.join('http://wizard.mancavekodi.com/tvkings/icon.png'))
...
Guide = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvpro-pvrguide/resources/catchup', 'guide.xml'))
GuideLoc = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvpro-pvrguide/resources/catchup', 'g'))
...
tvprotvfol = xbmc.translatePath(os.path.join(ADDON_DATA,'plugin.video.tvpro-pvrguide'))
tvprotvset = xbmc.translatePath(os.path.join(ADDON_DATA,'settings.xml'))
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvpro-pvrguide/resources/ivue','addons_index.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.tvpro-pvrguide/resources/ivue','addons_index.zip'))
...
def addonsettings(url,description):
	if   url =="CC":
		...
		xbmc.executebuiltin('Runscript("special://home/addons/plugin.video.tvpro-pvrguide/resources/modules/speedtest.py")')
	elif url =="META":
...
def accountinfo():
	...
	tools.addDir('http://techstreams.mancavekodi.com',All,2,icon,fanart,'')
	tools.addDir('http://atoztvkings.mancavekodi.com',All,2,icon,fanart,'')
	plugintools.set_view( plugintools.LIST )

	
def correctPVR():

	addon = xbmcaddon.Addon('plugin.video.tvpro-pvrguide')
	...
	loginurl   = "http://tvkings.tvstreams.xyz:83/get.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	EPGurl     = "http://tvkings.tvstreams.xyz:83/xmltv.php?username=" + username_text + "&password=" + password_text
...
def ivueint():
	...
	xbmc.executebuiltin('ActivateWindow(10025,"plugin://plugin.video.IVUEcreator/update_addon/plugin.video.tvpro-pvrguide",return)')
	xbmc.executebuiltin("XBMC.ActivateWindow(Home)")
...
def tvpro_settings():
	xbmc.executebuiltin("Addon.OpenSettings(plugin.video.tvpro-pvrguide)")
...
def testarea():
	tvstreamscat   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/plugin.video.tvpro-pvrguide/categories.db'))
	channels = []
