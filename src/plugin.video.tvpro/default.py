...
canada        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_canada.png'))
system        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_system.png'))
eleven        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_11_sports.png'))
espn          = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_espn_plus.png'))
kids          = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_kids.png'))
newsca        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_news_ca.png'))
newsus        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_news_us.png'))
newsuk        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_news_uk.png'))
premovies     = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_premium_movies.png'))
reality       = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_reality.png'))
docs          = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_docs.png'))
networks      = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_networks.png'))
airing        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_airing.png'))
guide         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_guide.png'))
extra         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_extra.png'))
catch         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_catch.png'))
vodtv         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_vodtv.png'))
american      = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_us.png'))
britsh        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_uk.png'))
international = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_international.png'))
music         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_music.png'))
music2        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_music2.png'))
adult         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_adult.png'))
ppv           = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_ppv.png'))
mlb           = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_mlb.png'))
sports2       = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_sports2.png'))
nba           = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_nba.png'))
nfl           = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_nfl.png'))
cache         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_cache.png'))
nhl           = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_nhl.png'))
speed         = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_speed.png'))
ncaa          = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_ncaa.png'))
community     = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_community.png'))
nascar        = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_nascar.png'))
f1            = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_f1.png'))
mls           = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_mls.png'))
topenglish    = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_topenglish.png'))
entertainment = xbmc.translatePath(os.path.join('https://raw.githubusercontent.com/MrKoyu/artwork/master/icons_hyper/master/icons_entertainment.png'))
...
live_url     = '%s:%s/enigma2_api.php?username=%s&password=%s&type=get_live_categories'%(host,port,username,password)
vod_url      = '%s:%s/enigma2_api.php?username=%s&password=%s&type=get_movie_categories'%(host,port,username,password)
series_url   = '%s:%s/enigma2_api.php?username=%s&password=%s&type=get_series_categories'%(host,port,username,password)
...
tvproaddons2ini  = xbmc.translatePath('special://profile/addon_data/script.ivueguide/addons2.ini')
...
def start():
    if username=="":
        ...
        if not auth=="":
            ...
            tools.addDir('[COLOR white]TV Series[/COLOR]','vod',3,vodtv,fanart,'')
...
def NEW_MENU():
    ...
    #tools.addDir('[COLOR gold]ESPN Plus[/COLOR]',ESPN_PLUS,25,espn,fanart,'')
    #tools.addDir('[COLOR white]EPL[/COLOR]',EPL_SPFL_Eleven_Sports,25,eleven,fanart,'')
    #tools.addDir('[COLOR gold]PPV Replay[/COLOR]',PPV_Replay,25,ppv,fanart,'')
    tools.addDir('[COLOR white]United States[/COLOR]',url,22,american,fanart,'')
    tools.addDir('[COLOR white]United Kingdom[/COLOR]',url,23,britsh,fanart,'')
...
def US():
    ...
    tools.addDir('[COLOR white]CBS Locals[/COLOR]',CBS_LOCALS,25,networks,fanart,'')
    tools.addDir('[COLOR white]FOX Locals[/COLOR]',FOX_LOCALS,25,networks,fanart,'')
    tools.addDir('[COLOR white]NBC Locals[/COLOR]',NBC_LOCALS,25,networks,fanart,'')
    #tools.addDir('[COLOR white]US Networks[/COLOR]',USA_LOCAL_NETWORKS,25,networks,fanart,'')
    #tools.addDir('[COLOR white]US[/COLOR]',USA_Music,25,music2,fanart,'')
    ...
    tools.addDir('[COLOR white]ESPN Plus[/COLOR]',ESPN_PLUS,25,espn,fanart,'')
    tools.addDir('[COLOR white]NFL[/COLOR]',NFL_Package,25,nfl,fanart,'')
    tools.addDir('[COLOR white]MLB[/COLOR]',MLB_Package,25,mlb,fanart,'')
    tools.addDir('[COLOR white]MLS[/COLOR]',MLS_Package,25,icon,fanart,'')
    tools.addDir('[COLOR white]NCAAF[/COLOR]',NCAAF,25,ncaa,fanart,'')
    #tools.addDir('[COLOR white]Nascar[/COLOR]',Nascar,25,nascar,fanart,'')
...
def UK():
    ...
    tools.addDir('[COLOR white]BT Sports[/COLOR]',BT_SPORTS,25,sports2,fanart,'')
    tools.addDir('[COLOR white]BBC Red Button Sports[/COLOR]',BBC_RED_BUTTON_SPORTS,25,sports2,fanart,'')
    tools.addDir('[B][COLOR black]=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','','',icon,fanart,'')
    tools.addDir('[COLOR white]Clear Cache[/COLOR]','CC',10,cache,fanart,'')
    tools.addDir('[COLOR white]Search[/COLOR]','url',5,search2,fanart,'')
    setView()
...
def INT():
    tools.addDir('[B][COLOR white]=-=-=-=-=-=-=-=-=-=[/COLOR][/B] [B][COLOR white]INTERNATIONAL[/COLOR][/B] [B][COLOR white]=-=-=-=-=-=-=-=-=-=[/COLOR][/B]','','',international,fanart,'')
    ...
    tools.addDir('[COLOR white]Norway[/COLOR]',Norway,25,international,fanart,'')
...
def ALL_247():    
    ...
    tools.addDir('[COLOR white]TV Shows A-G[/COLOR]',twentyfourseven_AG,25,catch,fanart,'')
    tools.addDir('[COLOR white]TV Shows H-N[/COLOR]',twentyfourseven_HN,25,catch,fanart,'')
    tools.addDir('[COLOR white]TV Shows O-U[/COLOR]',twentyfourseven_OU,25,catch,fanart,'')
    tools.addDir('[COLOR white]TV Shows V-Z[/COLOR]',twentyfourseven_VZ,25,catch,fanart,'')
    tools.addDir('[COLOR white]Kids[/COLOR]',twentyfourseven_Kids,25,catch,fanart,'')
    tools.addDir('[COLOR white]Adult Cartoons[/COLOR]',twentyfourseven_ADULT,25,catch,fanart,'')
    tools.addDir('[COLOR white]Latin[/COLOR]',twentyfourseven_Latin,25,catch,fanart,'')
    tools.addDir('[COLOR black]=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=[/COLOR]','','',icon,fanart,'')
    tools.addDir('[COLOR white]Search[/COLOR]','url',5,search2,fanart,'')
    tools.addDir('[COLOR white]Clear Cache[/COLOR]','CC',10,cache,fanart,'')
    setView()
